...
<body>
    ...
    <h2>HM Schedule</h2>
    <form action="hm_save_learner.php" method="post"> <!-- Updated action attribute -->
        ...
        <select id="qualification" name="qualification" required>
            <option value="HOUSE KEEPING NC II">HOUSE KEEPING NC II</option>
            ...
            <option value="EVENT MANAGEMENT SERVICES NC III">EVENT MANAGEMENT SERVICES NC III</option>
        </select><br><br>
